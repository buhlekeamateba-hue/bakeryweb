...
## Design Approach
- Warm bakery-inspired colour scheme using CSS variables
- Simple and clean layout for easy navigation
- Card-based product design using Flexbox
...
### Part 1
- Created website structure using HTML
- Added navigation between pages
- Built product listing pages
- Added basic content and images
